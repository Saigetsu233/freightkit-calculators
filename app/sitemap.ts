...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const latestLastModified = new Date("2026-09-09");
  return [
    ...
    { url: `${base}/contact`, lastModified: latestLastModified, changeFrequency: "yearly", priority: .2 },
    ...
    { url: `${base}/privacy`, lastModified: latestLastModified, changeFrequency: "yearly", priority: .2 },
