...
const changes = [
  { date: "2026-08-16", label: "August 16, 2026 · v1.6", title: "Carrier-rated dimensions and complete pallet counts", items: ["Dimensional-weight comparisons now apply carrier-specific dimension rounding before calculating each row.", "Added the USPS one-cubic-foot applicability check and the July 2026 divisor and rounding rule.", "Expanded pallet loading from one-pallet capacity to full shipment planning, including pallets required and the final partial pallet.", "Added concise tool search descriptions and meaningful route-level sitemap dates."] },
