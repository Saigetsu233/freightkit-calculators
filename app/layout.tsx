...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Free dimensional weight, CBM, carton, pallet, container, shipping cost, and ecommerce margin calculators.",
    ...
    openGraph: {
      ...
      description: "Ten free calculators for packaging, ecommerce, and freight teams.",
      url: base,
